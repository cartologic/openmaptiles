...
or use the provided `quickstart.sh` script to automatically download and import given area. If area is not given, gcc-states will be imported. List of available areas `make list-geofabrik`.
